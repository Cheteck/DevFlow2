# Responsabilites — adapter credential-store-postgres

| Champ | Valeur |
|---|---|
| Nom | `@mosaix/adapter-credential-store-postgres` |
| Version | `0.1.0` |
| Couche | Adapter concret (Layer 3) |

## Raison d'etre

Implementer `ports-credential-store` : Persistance credentials sur PostgreSQL.
