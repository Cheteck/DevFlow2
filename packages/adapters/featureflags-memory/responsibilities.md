# Responsabilites — adapter featureflags-memory

| Champ | Valeur |
|---|---|
| Nom | `@mosaix/adapter-featureflags-memory` |
| Version | `1.0.0` |
| Couche | Adapter concret (Layer 3) |

## Raison d'etre

Implementer `ports-feature-flags` : Flags in-memory (defaults, overrides de test).
