# Responsabilites — adapter cache-memory

| Champ | Valeur |
|---|---|
| Nom | `@mosaix/adapter-cache-memory` |
| Version | `1.0.0` |
| Couche | Adapter concret (Layer 3) |

## Raison d'etre

Implementer `ports-cache` : Cache Map in-memory avec TTL — dev/test, sans dependance externe.
