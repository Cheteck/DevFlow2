# Responsabilites — plugin commerce-recently-viewed-plugin

| Champ | Valeur |
|---|---|
| Nom | `@mosaix-plugin/commerce-recently-viewed` |
| Version | `voir package.json` |
| Couche | Extension (Plan controle & extension) — hote : commerce |

## Raison d'etre

Historique recents vus (par visiteur/session) — contribution UI + stockage leger.
