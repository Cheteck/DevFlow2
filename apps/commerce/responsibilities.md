# Responsabilites — app commerce

| Champ | Valeur |
|---|---|
| Nom | `@apps/commerce` |
| Version | `voir package.json` |
| Couche | Application BAC (Layer 7) — Commandes & checkout |

## Raison d'etre

Orders, sagas de checkout avec compensation (orchestration), paiement, capabilities commerce.order.create/read, workflows/ ; etendu par 5 plugins commerce-*.
