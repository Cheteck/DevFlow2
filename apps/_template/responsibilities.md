# Responsabilites — app _template

| Champ | Valeur |
|---|---|
| Nom | `__APP_ID__` |
| Version | `voir package.json` |
| Couche | Application BAC (Layer 7) — Gabarit |

## Raison d'etre

Squelette canonique d'app (MANIFEST, ServiceProvider, factory createApp, domain/application/infrastructure) a copier pour toute nouvelle BAC. Non deploye.
