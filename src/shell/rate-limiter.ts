...
export class RateLimiter {
  ...
  checkLimit(req: IncomingMessage, routeKey: string = "default"): { allowed: boolean; remaining: number } {
  ...
  middleware(routeKey: string = "default"): (req: IncomingMessage, res: ServerResponse) => boolean {
